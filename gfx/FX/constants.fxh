...
static const float 	MUD_CAM_MIN 				= 0.0f;
static const float 	MUD_CAM_MAX 				= 0.0f;
...
static const float 	SNOW_TILING  				= 0.0f;
static const float 	SNOW_NOISE_TILING  			= 0.0f;
static const float 	SNOW_ICE_NOISE_TILING  		= 0.0f;
static const float 	SNOW_FROST_MIN_EFFECT  		= 0.0f;
...
static const float COLORMAP_OVERLAY_STRENGTH 	= 0.8f; //DH 0.75f;
...
// SUPPLY FIX xD
static const float GB_STRENGTH_CH1 = 1.0; // [1.0] Opacity of bottom layer
static const float GB_STRENGTH_CH2 = 0.6; // [0.2] to [0.6] Opacity of top layer
static const float GB_FIRST_LAYER_PRIORITY = 0.6; // [0.2] to [0.8]  Priority for first/second layer when both are active at the same pixel
